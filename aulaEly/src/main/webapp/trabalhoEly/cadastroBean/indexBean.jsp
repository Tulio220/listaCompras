...
<div class="container">
    ...
    <a href="add_jogoBean.jsp" class="btn btn-primary">Adicionar Jogo</a>
            ...
            <c:forEach var="jogo" items="${jDao.listarJogos()}">
                <tr>
                    ...
                    <td class="text-center">
                        <a href="edit_jogoBean.jsp?id=${jogo.id}" class="btn btn-warning btn-sm">Alterar</a>
                        <a href="excluirBean.jsp?id=${jogo.id}" class="btn btn-danger btn-sm">Excluir</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
